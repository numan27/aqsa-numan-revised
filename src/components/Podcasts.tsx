      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Sharing my journey and insights on popular podcasts in the design and tech space.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {podcastAppearances.map((appearance, index) => (
            <div key={index} className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-purple-600 font-medium mb-3">{appearance.podcast}</p>
        ...
        <div className="bg-gray-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            I'd love to share my story and insights with your audience. Topics I discuss 
            include design, entrepreneurship, community building, and work-life balance.
          </p>
