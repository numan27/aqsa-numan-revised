  ...
  const communities = [
    {
      title: "Tech CEO Hub",
      description:
        "A curated WhatsApp group for startup founders and tech leaders. Collaborate, share, and grow together.",
      members: "150+ CEOs",
      type: "Private Group",
    ...
    },
    {
      ...
      description:
        "A job-focused community that helps tech professionals find real, vetted opportunities.",
    ...
    },
    {
      title: "IxDF Lahore",
      description:
        "Leading the Lahore chapter of the Interaction Design Foundation. Hosting events and collaborative design sessions.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {communities.map((community, index) => (
            <div
              key={index}
              className="animated-border rounded-md p-8 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 group"
            >
              <div className="mb-4">
