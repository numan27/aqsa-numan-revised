  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "How to create design systems that grow with your startup and maintain consistency.",
    ...
    },
    {
      ...
      excerpt:
        "Lessons learned from growing multiple tech communities from zero to thousands of members.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Insights on design, career growth, and building sustainable success
            in tech.
          </p>
        </div>
