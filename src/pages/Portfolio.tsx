  ...
  const projects = [
    {
      ...
      description: "Complete redesign of a financial dashboard focusing on data visualization and user experience improvements.",
      image: "photo-1486312338219-ce68d2c6f44d",
      tags: ["UI Design", "UX Research", "Prototyping"],
      results: "40% increase in user engagement, 25% reduction in task completion time"
    },
    {
      title: "E-commerce Mobile App",
      category: "Mobile Design",
      description: "End-to-end design of a fashion e-commerce app with focus on seamless shopping experience.",
    ...
    },
    {
      ...
      description: "Comprehensive design system and interface for a project management SaaS platform.",
    ...
    },
    {
      ...
      description: "Patient portal design focusing on accessibility and ease of use for all age groups.",
    ...
    },
    {
      ...
      description: "High-converting landing pages for various tech startups focusing on clear messaging and CTAs.",
    ...
    },
    {
      ...
      description: "Comprehensive design system for a multi-product company ensuring consistency across platforms.",
      image: "photo-1487058792275-0ad4aaf24ca7",
      tags: ["Design Tokens", "Component Design", "Documentation"],
      results: "80% faster design-to-development handoff, unified brand experience"
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "Aqsa's design work transformed our user experience completely. The attention to detail and user-centric approach resulted in significant improvements in our metrics.",
      project: "SaaS Platform Interface"
    },
    {
      name: "Ahmed Khan",
      role: "CEO at RetailNext",
      content: "The mobile app design exceeded our expectations. Aqsa understood our vision and delivered a solution that our users absolutely love.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center animate-fade-in">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <span className="px-4 py-2 bg-purple-100 text-purple-600 rounded-full text-sm font-medium">All Projects</span>
              <span className="px-4 py-2 bg-gray-100 text-gray-600 rounded-full text-sm font-medium hover:bg-purple-100 hover:text-purple-600 transition-colors cursor-pointer">UI/UX Design</span>
              <span className="px-4 py-2 bg-gray-100 text-gray-600 rounded-full text-sm font-medium hover:bg-purple-100 hover:text-purple-600 transition-colors cursor-pointer">Mobile Design</span>
              <span className="px-4 py-2 bg-gray-100 text-gray-600 rounded-full text-sm font-medium hover:bg-purple-100 hover:text-purple-600 transition-colors cursor-pointer">Design Systems</span>
            </div>
          </div>
        </div>
      </section>
              ...
              <div key={index} className="group cursor-pointer">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-green-50 rounded-lg">
                    <div className="text-sm text-green-600 font-medium mb-1">Results</div>
              ...
              <div key={index} className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-sm text-purple-600 font-medium">Project</div>
